  ...
  <div class="meau-ct">
    <div class="meau-sort-ct">
      ...
      <div class="meau-sort-pct">
        <div class="sort-pitem" v-for="(item,index) in sortImgArr" :key="index">
          <img :src="item.img" @mouseover="checkIn(index)" @mouseout="checkOut"
    ...
    <div class="meau-recm-ct" v-if="sortActive">
      ...
      <div class="meau-recm-pct">
        ...
        <div class="recm-pics">
          <div class="recm-pitem" v-for="(i,index) in listRecm[recmindex]" :key="index">
            <img :src="i.imgUrl">
            <p>{{i.name}}</p>
            <p style="color:orange">{{i.sort}}</p>
    ...
    <div class="meau-list-ct">
      <h2 style="text-align:center">{{listsort}}商品列表</h2>
      <div class="meau-list-itemct" 
        v-for="(i,index) in listItems"  :key="i.id"
        ...
        <div class="list-item-msg">
          <p :style="{ color : (isActive == index ) ? 'yellowgreen' : 'blue' }" 
...
<style scoped>
  ...
  /*今日推荐*/
  .meau-recm-pct{
    box-shadow: 0 2px 4px rgba(0, 0, 0, .200), 0 0 6px rgba(0, 0, 0, .04);
  ...
  .recm-pitem img{
    box-shadow: 0 2px 4px rgba(0, 0, 0, .300), 0 0 6px rgba(0, 0, 0, .04);
    width:90%;
    height: 50%;
  }
  .recm-arrow{
